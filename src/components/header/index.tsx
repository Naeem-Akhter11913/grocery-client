...
const Header = () => {
  ...
  return (
    <div className='position-abssolute'>
      <header className="d-flex justify-content-between align-items-center py-2 px-2">
        ...
        <div className="d-flex justify-content-between mx-4 border border-green-300 rounded-md overflow-hidden position-relative custom-search-width">
          <div className="px-4 py-2 bg-white text-sm fw-semibold text-secondary d-flex align-items-center cursor-pointer" onClick={handleClicked}>
            All Categories
            <span className="ms-2">
              <ArrowDown />
            </span>
